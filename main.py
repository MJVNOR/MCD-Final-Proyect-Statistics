...
def datos():
    ...
    return bd1, bd_V_farnesiana, bd_R_communis


bd1, bd_V_farnesiana, bd_R_communis = datos()

tab1, tab2, tab3 = st.tabs(["Datos", "Farnesiana", "Communis"])
...
with tab2:
    ...
    with col1:
        ...
        for tratamiento in tratamientos:
            ...
            fig.add_trace(
                go.Bar(
                    x=df_variance_pca.index, y=df_variance_pca["Value"], name="Varianza"
                )
            )
